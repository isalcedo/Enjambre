		...
		<div class="contenedor_cuadro">
			<div class="cuadro_texto">
				...
				<div class="titulo_cuadro" style="background:#<?php echo $info_primer_color['color']; ?>">
					 ...
					 ?>
						...
						<p class="titulo"><?php  echo $info_enlaces['nombre'];?> Pa los panas</p>
					</div>
			...
			?>
				   ...
				   ?>
				    ...
				    <tr>
				     <td width="20%">
							...
							<img src="<?php echo $pathsalvapantallas.$foto_mini; ?>" width="60px" height="40px" border="0">
				  ...
				  ?>
				      ...
				      <td width="50%"><strong><?php echo $info_subenlaces['titulo']?></strong>
