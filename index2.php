    ...
    <body>
		...
		<div class="contenedor_general">
			...
			<div class="cuadro_texto">
            	<div class="contenedorslider" id="slider">
                	<ul>
                    	<?php
						...
						while ($row=mysql_fetch_array($res)) {
							if ($row['foto']==0) {
								...
								//echo "<li>$fotob</li>";
								echo '<li><img src="fotos/banners/'.$fotob.'" width="653" height="344" /></li>';
							}
						}
						?>
                    </ul>
			...
			<div class="talleres">
				...
				<p class="fecha_talleres">
					...
					Del <?php echo $info_talleres['fecha_desde'] ?>  al  <?php echo $info_talleres['fecha_hasta'] ?> </p>
                    <p class="titulotaller"><strong><?php echo $info_talleres['titulo'] ?></strong></p>
                    <p><?php echo $info_talleres['descripcion']; ?> </p>
					<?php }else{
				...
				<div class="ver_mas">
					<a href="formacion/"><img src="images/ver_mas_enjambre.png" alt="Ver m&aacute;s" /></a>
				</div>
			</div>
			<div class="talleres">
			
			<?php
					$sql_salvapantallas = "select id_salvapantallas, titulo
				...
				?>
						...
						<a href="salvapantallas/"><img src="<?php echo $pathsalvapantallas.$foto; ?>" width="110" height="74" id="fotosalva"></a>
				...
				<div class="ver_mas">
					<a href="salvapantallas/"><img src="images/ver_mas_enjambre.png" alt="Ver m&aacute;s" /></a>
				</div>
			</div>
		</div>
