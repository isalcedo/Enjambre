...
?>
		...
		<div class="contgrande">
			...
			<div class="contenedor"><a  href="./portafolio/index.php?id_enlace_s=<?php echo $info_imagenes['id_enlace_s']."&id_imagen_subenlace=".$info_imagenes['id_imagen_subenlace']."" ?>" rel="group2" class="grouped_elements"><img src="../fotos/subenlaces/<?php echo $foto_sub ?>" width="200" height="143" alt="imagen" /> <a/>

			</div>

	
			<div class="leyenda">
			  <p><a href="./portafolio/index.php?id_enlace_s=<?php echo $info_imagenes['id_enlace_s']."&id_imagen_subenlace=".$info_imagenes['id_imagen_subenlace']."" ?>" rel="group2" class="grouped_elements"><?php echo $info_imagenes['titulo_imagen']; ?></a></p>
			</div>
	...
	$foto_sub=unafoto($pathsubenlaces2,$info_videos['id_video_subenlace']);
		...
		?>
					...
					<div class="contgrande">
						...
						<div class="leyenda">
						  <p><a rel="group2" class="grouped_elements" href="./portafolio/index.php?id_enlace_s=<?php echo $info_videos['id_enlace_s']."&id_video_subenlace=".$info_videos['id_video_subenlace']."" ?>" ><?php echo $info_imagenes['titulo_video']; ?></a></p>
						</div>
...
?>
		...
		<?php 
			...
			if(array_search("youtu.be",$explode)){?>
			...
			<?php 
			}elseif(array_search("www.vimeo.com",$explode)){?>
