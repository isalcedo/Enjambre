...
<!--Contenido p?gina-->
		<div class="contenedor_general">
			...
			<div class="cuadro_texto">
						...
						?>
							...
							<div class="titulo_cuadro" style="background:#<?php echo $info_primer_color['color']; ?>">
							  ...
							  <?php
								$sql_enlaces ="select id_enlace_p , nombre, descripcion from enlace_principal where id_enlace_p='1'";
			...
			<?php
				...
				$sql_subenlaces = "select * from enlaces_secundarios  where id_enlace_p = '1'";
