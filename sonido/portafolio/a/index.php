...
<div class="autocien">
			gsgsg<img src="../../images/jose_jego.gif">
...
?>
    ...
    <div class="contenedor"><img src="<?php echo $pathsubenlaces.$foto_sub ?>" width="200" height="143" alt="imagen" /> 
      <div class="vermas"><a href="index.php?id_enlace_s=<?php echo $info_imagenes['id_enlace_s']."&id_imagen_subenlace=".$info_imagenes['id_imagen_subenlace']."" ?>"><img src="../../images/ver_mas_enjambre.png" alt="ver mas" width="38" height="38" border="0" /></a></div>
    </div>


			<div class="leyenda">
			  <p><a href="index.php?id_enlace_s=<?php echo $info_imagenes['id_enlace_s']."&id_imagen_subenlace=".$info_imagenes['id_imagen_subenlace']."" ?>"><?php echo $info_imagenes['titulo_imagen']; ?></a></p>
			</div>
